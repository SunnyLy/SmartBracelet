...
public class PullToRefreshScrollView extends PullToRefreshBase<ListenerScrollView> {
    ...
    @Override
    protected ListenerScrollView createRefreshableView(Context context, AttributeSet attrs) {
        ListenerScrollView scrollView;
        if (VERSION.SDK_INT >= VERSION_CODES.GINGERBREAD) {
            scrollView = new InternalScrollViewSDK9(context, attrs);
        } else {
            scrollView = new ListenerScrollView(context, attrs);
        }
    ...
    @TargetApi(9)
    final class InternalScrollViewSDK9 extends ListenerScrollView {
