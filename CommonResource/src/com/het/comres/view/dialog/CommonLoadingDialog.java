...
public class CommonLoadingDialog extends BaseDialog {
    ...
    HandlerUtil.MessageListener dismissListener = new HandlerUtil.MessageListener() {
        @Override
    ...
    HandlerUtil.StaticHandler dismissHandler = new HandlerUtil.StaticHandler(dismissListener);
