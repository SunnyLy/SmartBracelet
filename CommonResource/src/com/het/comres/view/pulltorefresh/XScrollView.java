package com.het.comres.view.pulltorefresh;
...
import com.het.comres.view.ListenerScrollView;


public class XScrollView extends ListenerScrollView implements OnScrollListener {
//    private static final String TAG = "XScrollView";
    ...
    private void initWithContext(Context context) {
        mLayout = (LinearLayout) View.inflate(context, R.layout.widget_xscrollview_layout, null);
