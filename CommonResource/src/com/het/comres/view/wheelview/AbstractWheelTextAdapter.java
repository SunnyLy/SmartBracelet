package com.het.comres.view.wheelview;
...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
     ...
     * Default text color
     */
    public static final int DEFAULT_TEXT_COLOR = 0xff676767;
...
//					textView.setTextSize(context.getResources().getDimension(R.dimen.textSize12));
//				}else{
                //textView.setTextColor(Color.parseColor("#676767"));
                textView.setTextColor(Color.parseColor("#b6b6b6"));
                textView.setTextSize(context.getResources().getDimension(R.dimen.common_textsize_small));
                //	}
    ...
    protected void configureTextView(TextView view) {
        ...
        // getLayoutParams(LayoutParams.MATCH_PARENT, height, top);
        // view.setHeight(80);
        if (itemHeight != 0) {
            view.setPadding(itemHeight / 3, itemHeight, itemHeight / 3,
                    itemHeight);
        }
