...
public class TextRoundCornerProgressBar extends LinearLayout {
    ...
    private void setup(Context context, AttributeSet attrs) {
        ...
        autoTextChange = typedArray.getBoolean(
                R.styleable.RoundCornerProgress_rcAutoTextChange, false);
        ...
        textSize = (int) typedArray.getDimension(
                R.styleable.RoundCornerProgress_rcTextProgressSize, textSize);
        textViewValue.setTextSize(TypedValue.COMPLEX_UNIT_PX, textSize);
        textViewValue
                .setTextColor(typedArray.getColor(
                        R.styleable.RoundCornerProgress_rcTextProgressColor,
                        textColor));
        text = typedArray
                .getString(R.styleable.RoundCornerProgress_rcTextProgress);
        text = (text == null) ? "" : text;
        textViewValue.setText(text);
        textPadding = (int) typedArray.getDimension(
                R.styleable.RoundCornerProgress_rcTextProgressPadding,
                textPadding);
        textViewValue.setPadding(textPadding, 0, textPadding, 0);
        textUnit = typedArray
                .getString(R.styleable.RoundCornerProgress_rcTextProgressUnit);
        textUnit = (textUnit == null) ? "" : textUnit;
        textWidth = (int) typedArray.getDimension(
                R.styleable.RoundCornerProgress_rcTextProgressWidth, textWidth);
        ...
        observer.addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                backgroundHeight = (height == 0) ? (int) dp2px(DEFAULT_PROGRESS_BAR_HEIGHT)
                        : height;
                ViewGroup.LayoutParams params = layoutBackground
                        .getLayoutParams();
