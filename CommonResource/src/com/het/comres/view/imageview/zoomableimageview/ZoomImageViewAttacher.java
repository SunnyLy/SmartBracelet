...
public class ZoomImageViewAttacher implements IZoomImageView, View.OnTouchListener, VersionedGestureDetector.OnGestureListener,
        OnDoubleTapListener, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public static boolean isSingleClick = false;////判断是否单击
    private ImageView view;////用来popupview显示位置
    public static boolean isNeedShowPopUp = false;////是否需要显示popupwindow
    ...
    private static void setImageViewScaleTypeMatrix(ImageView imageView) {
        if (null != imageView) {
            if (imageView instanceof IZoomImageView) {
                /**
    ...
    /*****
     * 在这个构造方法里面添加Context context,
     * 原先为 PhotoViewAttacher(ImageView imageView)
     *
     * @param imageView
     * @param context
     * @author sunny
     * @date 2014.4.7
     */
    public ZoomImageViewAttacher(ImageView imageView, Context context) {
     ...
     * This is automatically called if you are using {@link cn.yunlai.communityapp.common.component.photoview.PhotoView}.
     */
